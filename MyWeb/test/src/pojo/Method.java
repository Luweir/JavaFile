...
public class Method {
    ...
    public Method(Integer id, String methodName, String methodCallName, Integer modelId, String returnType, String methodDescription, Integer parameterCount, String expectedResult) {
        this.id = id;
